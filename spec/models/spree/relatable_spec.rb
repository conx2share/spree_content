shared_examples 'relatable content' do
  context 'class' do
    describe '.relation_types' do
      it 'returns all the RelationTypes in use for this Product' do
        relation_type = create(:relation_type, applies_to: described_class.to_s)
  ...
  context 'instance' do
    ...
    describe 'RelationType finders' do
      ...
      it 'recognizes the method with has_related_content?(method)' do
        expect(@product.has_related_content?('related_products')).to be_truthy
      end

      it 'does not recognize non-existent methods with has_related_content?(method)' do
        expect(@product.has_related_content?('unrelated_products')).not_to be_truthy
      end
...
Spree::Product.include Spree::Relatable

describe Spree::Product, type: :model do
  it_behaves_like 'relatable content'
end
